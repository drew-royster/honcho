...
# Create non-root user and runtime-writable cache directory.
RUN addgroup --system app && adduser --system --group app && mkdir -p /tmp/uv-cache && chown -R app:app /tmp/uv-cache
